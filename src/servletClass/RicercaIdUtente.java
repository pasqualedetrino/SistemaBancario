...
/**
 * Servlet implementation class RicercaIdUtente
 */
@WebServlet(description = "servlet per la ricerca di un utente per id", urlPatterns = { "/RicercaIdUtente.do" })
public class RicercaIdUtente extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public RicercaIdUtente() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int q = Integer.valueOf(request.getParameter("idUtente"));
		idUtente = q;
		RispostaRicerca rispostaRicerca = operazioniAmministratore.ricercaCorrentista(q);
		
		Utente u = new Utente(q);
		...
		out.println("<!DOCTYPE html>\r\n" + 
				...
				"						<li><i class=\"fa fa-angle-double-right\"></i></li>\r\n" + 
				"                        <li><span>RicercaIdUtente</span></li>\r\n" + 
				"                    </ul>\r\n" + 
				"                </div>\r\n" + 
				"            </div>\r\n" + 
				"        </div>\r\n" + 
	...
	if(!rispostaRicerca.getDataNascita().equals("nonEsiste")) {	
		...
		out.println("<a href = \"./tema/coinbuzz/RegistraUtente.html\">Registra Utente</a>");
