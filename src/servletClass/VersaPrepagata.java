...
/**
 * Servlet implementation class VersaPrepagata
 */
@WebServlet(description = "servlet per versare importo su carta prepagata", urlPatterns = { "/VersaPrepagata.do" })
public class VersaPrepagata extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public VersaPrepagata() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		float versamento = Float.valueOf(request.getParameter("saldoPrepagata"));
		...
		CartaPrepagata cartaPrepagata = new CartaPrepagata(id);
